...
namespace Student_Application_MVC_29_Jan.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Rollno,Name,Mobile,Addr")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Rollno,Name,Mobile,Addr")] Student student)
        {
